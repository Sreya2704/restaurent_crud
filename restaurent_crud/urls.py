"""
URL configuration for restaurent_crud project.
...
from api.views import RestaurantListCreateView,RestaurantRetrieveUpdateDeleteView,DishCreateView,DishRetrieveUpdateDeleteView
